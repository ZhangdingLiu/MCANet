...
class ResNet152_CSRA(ResNet):
    ...
    def __init__(self, num_heads, lam, num_classes, depth=152, input_dim=2048, cutmix=None):
        self.block, self.layers = self.arch_settings[depth]
        self.depth = depth
        super(ResNet152_CSRA, self).__init__(self.block, self.layers)
