...
class ResNet101_Multilabel(ResNet):
    ...
    def backbone(self, x):
        ...
        x = self.avgpool(x)  # 1×1*2048 or 2048   after this, thinking whether should add this part of code to the forward part. because the cam attention is difficult to alter
